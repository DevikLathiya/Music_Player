            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) {
                return Obx(() => customListView(
                    image: "images/music.png", singer: "${list[index].artist}",index: index,
                    title: list[index].displayName, icon: (c.isPlaying[index]) ? Icons.pause_circle : Icons.play_circle,
                    songTap: () {
    ...
    return InkWell(
      ...
      child: Container(padding: const EdgeInsets.symmetric(vertical: 8,horizontal: 10),
        ...
        decoration: BoxDecoration(
            ...
            // boxShadow: [
            //   (c.isPlaying[index!]) ? BoxShadow(color: Colors.grey.shade500,blurRadius: 1,offset: Offset(1, 1)) : BoxShadow(),
            //   (c.isPlaying[index!]) ? const BoxShadow( color: Colors.white,blurRadius: 1,offset: Offset(-1, -1)) : BoxShadow()
            // ]
        ),
        child: Row(
          children: [
